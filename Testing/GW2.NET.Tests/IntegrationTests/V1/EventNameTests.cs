// <copyright file="EventNameTests.cs" company="GW2.NET Coding Team">
...
namespace GW2NET.IntegrationTests.V1
{
    ...
    public class EventNameTests
    {
        ...
        {
            var repository = GW2.V1.EventNames.ForDefaultCulture();
        ...
        public void Find_NotSupported(Guid identifier)
        {
            var repository = GW2.V1.EventNames.ForDefaultCulture();
        ...
        [Theory]
        [MemberData("GetIdentifiers")]
        public async void FindAsync_NotSupported(Guid identifier)
        {
            var repository = GW2.V1.EventNames.ForDefaultCulture();
