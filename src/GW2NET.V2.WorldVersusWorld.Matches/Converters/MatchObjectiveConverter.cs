...
namespace GW2NET.V2.WorldVersusWorld.Matches.Converters
{
    ...
    /// <summary>Converts objects of type <see cref="MatchObjectiveDTO"/> to objects of type <see cref="MatchObjective"/>.</summary>
    public sealed class MatchObjectiveConverter : IConverter<MatchObjectiveDTO, MatchObjective>
    {
        private readonly IConverter<string, TeamColor> teamColorConverter;

        /// <summary>Initializes a new instance of the <see cref="MatchObjectiveConverter"/> class.</summary>
        /// <param name="teamColorConverter">The converter for <see cref="TeamColor"/>.</param>
        public MatchObjectiveConverter(IConverter<string, TeamColor> teamColorConverter)
        {
        ...
        /// <summary>Converts the given object of type <see cref="MatchObjectiveDTO"/> to an object of type <see cref="MatchObjective"/>.</summary>
        /// <param name="value">The value to convert.</param>
        /// <param name="state"></param>
        /// <returns>The converted value.</returns>
        public MatchObjective Convert(MatchObjectiveDTO value, object state)
        {
            if (value == null)
            {
