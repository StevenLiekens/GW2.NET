...
// </copyright>
// <summary>
//   Converts objects of type <see cref="ConsumableDTO" /> to objects of type <see cref="ImmediateConsumable" />.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace GW2NET.V1.Items.Converters
{
    ...
    /// <summary>Converts objects of type <see cref="ConsumableDTO"/> to objects of type <see cref="ImmediateConsumable"/>.</summary>
