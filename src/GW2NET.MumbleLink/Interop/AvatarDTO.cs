// <copyright file="AvatarDTO.cs" company="GW2.NET Coding Team">
...
namespace GW2NET.MumbleLink.Interop
{
    ...
    [SuppressMessage("StyleCop.CSharp.NamingRules", "SA1305:FieldNamesMustNotUseHungarianNotation", Justification = "Native types do not follow the same naming conventions.")]
